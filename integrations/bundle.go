...
//go:embed golang/golang.wasm golang/manifest.toml git/git.wasm git/manifest.toml node/node.wasm node/manifest.toml make/make.wasm make/manifest.toml dotenv/dotenv.wasm dotenv/manifest.toml python/python.wasm python/manifest.toml rust/rust.wasm rust/manifest.toml brew/brew.wasm brew/manifest.toml uv/uv.wasm uv/manifest.toml rustup/rustup.wasm rustup/manifest.toml docker/docker.wasm docker/manifest.toml
